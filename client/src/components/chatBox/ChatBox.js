...
const ChatBox = ({ isListening, setIsListening, isNyraSpeaking, setActivate, username, messages, handleNewCommand, style }) => {
            ...
            <div className="chatBox">
                <div className="chatBox__head">
                    <div className="chatBox__chatInfo">
                        <img className={`chatBox__avatar ${isNyraSpeaking ? "chatBox__nyraSpeaks" : ""}`} src={NYRA_PNG} alt="" />
                        <div className="chatBox__nyraInfo">
                            <p>Nyra</p>
                            <p>I'm Nyra, your first friend!</p>
                        </div>
                    </div>
                ...
                <div className="chatBox__messages" ref={chatBox}>
                    <p className="chatBox__welcomeMsg">This is Nyra, your very own personal assistant.<br /> Nice to meet you {username?.split(" ")[0] || "user"}!</p>
                ...
                <form className="chatBox__newMessage" onSubmit={e => handleCommandSubmit(e)}>
                    ...
                    <input placeholder="Type your message." value={command} onChange={e => setCommand(e.target.value)} />
